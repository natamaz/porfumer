	...
	uglify: {
		dist: {
			files: {
				...
				'../markup/js/all-text-slide.min.js': ['dist/js/plugin/all-text-slide.js'],
				'../markup/js/all-banner-slide.min.js': ['dist/js/plugin/all-banner-slide.js'],
				'../markup/js/all-some-products-slide.min.js': ['dist/js/plugin/all-some-products-slide.js'],
				'../markup/js/all-delivery-slide.min.js': ['dist/js/plugin/all-delivery-slide.js'],
				'../markup/js/slide-we.min.js': ['dist/js/plugin/slide-we.js'],
			},
		}
	},
